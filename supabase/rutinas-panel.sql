-- =============================================================
--  Lifestyle · Panel admin: añadir cumplimiento de rutinas
--  Ejecuta este script en el SQL Editor de Supabase.
-- =============================================================

-- Se recrea la función para añadir dos columnas:
--  routines_active  = nº de rutinas fijas de la usuaria
--  routines_done_7  = rutinas completadas en los últimos 7 días
drop function if exists public.admin_usage_overview();
...
returns table (
  ...
  routines_active bigint, routines_done_7 bigint
...
begin
  ...
  select u.id, u.email::text, u.created_at,
    ...
    (select count(*) from public.routines r
       where r.user_id = u.id and r.is_occasional = false),
    (select count(*) from public.routine_completions rc
       where rc.user_id = u.id and rc.log_date >= current_date - 6)
  from auth.users u
